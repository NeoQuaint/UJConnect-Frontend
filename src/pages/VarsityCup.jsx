...
const VarsityCup = () => {
  ...
  const posts = [
    { id: 1, user_name: 'Thabo M.', user_dept: 'Applied Information Systems', content: 'UJ vs Wits Varsity Cup! The energy was unreal', media_url: '/run.mp4', media_type: 'video', likes_count: 532, comments_count: 89, created_at: new Date(Date.now() - 3600000).toISOString() },
    { id: 2, user_name: 'Lerato K.', user_dept: 'Marketing', content: 'Game day vibes! UJ taking the cup home', media_url: '/run.mp4', media_type: 'video', likes_count: 421, comments_count: 67, created_at: new Date(Date.now() - 7200000).toISOString() },
    { id: 3, user_name: 'Karabo S.', user_dept: 'Law', content: 'Finals watch party was insane!', media_url: '/run.mp4', media_type: 'video', likes_count: 389, comments_count: 45, created_at: new Date(Date.now() - 10800000).toISOString() },
    { id: 4, user_name: 'Amahle Z.', user_dept: 'Information & Knowledge Management', content: 'Rugby team bringing the heat! UJ pride', media_url: '/run.mp4', media_type: 'video', likes_count: 276, comments_count: 34, created_at: new Date(Date.now() - 14400000).toISOString() },
  ];
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#000', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif', maxWidth: 600, margin: '0 auto', position: 'relative', paddingBottom: '80px', color: 'white' }}>
      <div style={{ padding: '12px 20px', borderBottom: '1px solid #222', position: 'sticky', top: 0, background: '#000', zIndex: 10, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <h2 style={{ fontSize: '18px', fontWeight: 700, margin: 0, color: 'white' }}>Varsity Cup</h2>
          ...
          <div key={post.id} style={{ borderBottom: '1px solid #1a1a1a' }}>
            ...
            <div style={{ padding: '16px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '12px' }}>
                <div style={{ width: 40, height: 40, borderRadius: '50%', background: getFacultyColor(post.user_dept), display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontWeight: 700, fontSize: 15, flexShrink: 0 }}>{(post.user_name || '?').charAt(0)}</div>
